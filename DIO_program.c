...
static u8 Private_u8AccessPinDirection(  volatile u8* Copy_P_u8PORTX_REG, u8 Copy_u8PinId, u8 Copy_u8PinDirection ) {
...
static u8 Private_u8AccessPortDirection( volatile u8* Copy_P_u8PORTX_REG, u8 Copy_u8PortDirection ) {
 	u8 Local_u8ErrorState = STD_TYPES_OK;
